...
export default function Reviews() {
    ...
    const handleCreateReview = async (values: any) => {
        try {
            // Make actual API call to create performance review
            ...
            toast.error(error instanceof Error ? error.message : "Failed to create performance review");
        }
    };
                ...
                >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Dialog open={isCreateReviewDialogOpen} onOpenChange={setIsCreateReviewDialogOpen}>
